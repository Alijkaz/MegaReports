...
public class Queries {
        ...
        public static String CLOSE_REPORT = "UPDATE megareports_reports SET closed_at = ?, closed_reason = ?  WHERE id = ?";
        public static String OPEN_REPORT = "UPDATE megareports_reports SET closed_at = NULL, closed_reason = NULL  WHERE id = ?";
